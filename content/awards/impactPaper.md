...
## Winners
- 2024 Marcel Bruch, Martin Monperrus, and Mira Mezini. Learning from Examples to Improve Code Completion Systems. In Proceedings of the 17th ACM SIGSOFT Symposium on the Foundations of Software Engineering and 12th European Software Engineering Conference (ESEC/FSE 2009, Amsterdam, The Netherlands, Aug 2011). "For pioneering the use of machine learning to assist developers in generating code snippets, paving the way for today’s intelligent code assistance tools."
